(function () {
  ...
  function renderView() { if (activeView === "crm") return renderCrmShortcut(); if (activeView === "notes") return renderNotesView(); if (activeView === "backup") return renderBackup(); return renderClients(); }
